...
const makeValidatesGenreName = array => {
  array.forEach(object => {
    object.genre_names = [];
    object.genre_ids.forEach((idGenre, indexGenre, arrayMain) => {
      requestService.getGenresMovies().then(array => {
...
const setValidatesPosterPath = array => {
  array.forEach(object => {
    object.poster_path = makeValidatesPosterPath(object.poster_path);
  });
  return array;
};
